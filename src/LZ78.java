	...
	public static void main(String[] args) throws IOException{
		...
		while(true) {
			...
			if (operation == 1 && source == 1){
				...
				File file = new File("C:\\Users\\DELL\\Desktop\\multimedia\\" + fileName + ".txt"); 
				Scanner sc = new Scanner(file); 
								
				File fout = new File("C:\\Users\\DELL\\Desktop\\multimedia\\"+ fileName + "Compressed.txt");
				if (!fout.exists()) {
					fout.createNewFile();
				}
				...
				File fout = new File("C:\\Users\\DELL\\Desktop\\multimedia\\"+ fileName + "Decompressed.txt");
				if (!fout.exists()) {
					fout.createNewFile();
				}
